...
<!--
  ...
  function deleteById(id) {
      if(confirm("  确定删除 ?")){
            window.location = "${root}/admin/hotsearch/delete/"+id+".c";
        }
    }
...
<body class="bodymargin">
    ...
    %>
    <form action="${root}/admin/hotsearch/query.c" id="form1" method="post">
    <table class="mars" style="width: 100%">
    <thead>
    	<tr><td>商家管理  >> 热点产品管理</td></tr>
    </thead>
    </table>
        <input type="hidden" id="curPageNO" name="curPageNO" value="${curPageNO}" />
         <auth:auth ifAnyGranted="F_VIEW_ALL_DATA">
            ...
            <a href="${root}/pages/hotsearch/hotsearch.jsp" title="创建热点产品"><img src="${root}/img/grid_add.png"></a>
    </form>
        <%@ include file="/common/jsp/messages.jsp"%>
    <display:table name="list" requestURI="/admin/hotsearch/query.c" id="item"
      ...
      <a href= "${root}/admin/hotsearch/load/${item.id}.c" title="修改"><img alt="修改" src="${root}/img/grid_edit.png"></a>
