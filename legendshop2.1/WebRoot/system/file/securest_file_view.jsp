...
<center>
                ...
                <%
                 	      String filePath = EnvironmentConfig.getInstance().getPropertyValue(
					                 FileConfig.ConfigFile, "DownloadPath") + "securest/";
                  ...
                  <tr >
                    ...
                    <td>
                        <a href="<%=request.getContextPath()%>/servlet/downloadfileservlet/securest/<%=java.net.URLEncoder.encode(files[i].getName(),"UTF-8") %>">下载</a>
                    </td>
                   </tr>
 		      <%} }%>
                </table>
