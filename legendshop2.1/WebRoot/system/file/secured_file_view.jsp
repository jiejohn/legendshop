...
<center>
                ...
                <%
                 	      String filePath = EnvironmentConfig.getInstance().getPropertyValue(
					                 FileConfig.ConfigFile, "DownloadPath") + "secured/";
                  ...
                  <tr >
                    ...
                    <td >
                        <a href="<%=request.getContextPath()%>/servlet/downloadfileservlet/secured/<%=java.net.URLEncoder.encode(files[i].getName(),"UTF-8") %>">下载</a>
                    </td>
                   </tr>
 		      <%} }%>
                </table>
