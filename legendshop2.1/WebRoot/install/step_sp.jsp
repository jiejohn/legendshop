...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr>
    ...
    <td width="13%" align="right" valign="middle" class="line"><CENTER>
      <span class="STYLE3">LegendShop V2.0 </span>
    </CENTER></td>
  </tr>
</table>
<br>
...
<div style="border:1px solid #000000;">
  <table width="310" height="56" border="0" cellpadding="4" cellspacing="0">
    <tr>
      <td width="88" height="56" align="center" valign="middle" bgcolor="#FFFFFF"><img src="imgs/installing.gif" width="60" height="60"></td>
    ...
    <td width="79%" align="left" valign="top"><table width="778" border="0" cellpadding="3" cellspacing="0">
      ...
      <tr>
        <td width="760">
<form name="form1" method="post" action="finish.jsp">
...
<table width="100%" height="40" border="0" cellpadding="5" cellspacing="0" bgcolor="#FFFFCC">
                ...
                <tr> 
                  <td colspan="2"><input type="button" name="Submit2" value="开始检测数据库" onClick="contactDB();"></td>
                </tr>
              </table>            </td>
          </tr>
        </table>
      ...
      <tr>
        ...
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		            <input type="button" name="Submit" value="导入数据库，完成安装" disabled id="nextb" onClick="install(this)" style="height:30px;">
		            </form>		  </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
