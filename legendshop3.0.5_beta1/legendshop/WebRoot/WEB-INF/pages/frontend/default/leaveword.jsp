...
<table width="100%" class="tables" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td>
							<form method="POST" action="${pageContext.request.contextPath}/admin/userComment/save" id="form1" name="form1"  onsubmit="return validateRandNum('${pageContext.request.contextPath}');">
