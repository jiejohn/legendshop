                        ...
                        <br>
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" style="margin-bottom: 6">
                              ...
                              <tr> 
                                ...
                                <td height="29"><div align="left"> 
                                   <a href="${pageContext.request.contextPath}/regItem" target="_blank"><fmt:message key="UserAgreement"/></a><input type="checkbox" id="agreement" name="agreement" checked="checked"/>
