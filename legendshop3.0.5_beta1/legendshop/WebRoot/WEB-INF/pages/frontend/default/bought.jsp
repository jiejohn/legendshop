			...
			<c:forEach items="${requestScope.baskets}" var="basket">
				<tr>
				  <c:if test="${'C2C' == applicationScope.BUSINESS_MODE}">
					<td height="25">
						<div align="center">
							<a href="<ls:domain shopName='${basket.shopName}' />">${basket.shopName}</a>
						</div>
					</td>
				</c:if>
					<td>
						<a target="_blank" href="${pageContext.request.contextPath}/views/${basket.prodId}"><font
				...
				<tr>
					<td colspan="8">
						<div style="margin: 3px">
							...
							<a href="${pageContext.request.contextPath}/p/cash" onMouseOver="btnMouseOver('mbtn2')"
