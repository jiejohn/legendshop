...
<script>
	function submitSearchAllform(entityType,keyword){
        ...
        document.getElementById("searchAllform").action = "${pageContext.request.contextPath}/searchall?entityType=" + entityType +"&keyword="+keyword;
...
<table width="550px" style="margin: 10px">
	...
	<td align="left">
		<a href="${pageContext.request.contextPath}/searchall?entityType=1&keyword=LegendShop">LegendShop软件商城</a>
		<a href="${pageContext.request.contextPath}/searchall?entityType=1&keyword=360buy">360buy天天购物网</a>
    </td></tr>
	<tr><td align="right">热门商品:</td>
	<td align="left">
	<a href="${pageContext.request.contextPath}/searchall?entityType=0&keyword=戴尔">戴尔</a>
	<a href="${pageContext.request.contextPath}/searchall?entityType=0&keyword=CPU">CPU</a>
	<a href="${pageContext.request.contextPath}/searchall?entityType=0&keyword=索尼 SONY">SONY</a>
	<a href="${pageContext.request.contextPath}/searchall?entityType=0&keyword=创维">创维</a>
	<a href="${pageContext.request.contextPath}/searchall?entityType=0&keyword=三星 SAMSUNG">三星SAMSUNG</a>
	</td>
	</tr>
</table>
</c:if>
