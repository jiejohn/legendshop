...
<title>创建用户</title>
   ...
   <script language="javascript">
	...
	jQuery("#password").blur(function() {
      ...
      <form  action="${pageContext.request.contextPath}/admin/member/user/save" id="form1" method="post">
      
        <table class="${tableclass}" style="width: 100%">
	    <thead>
	    	<tr><td><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 用户管理  &raquo; <a href="${pageContext.request.contextPath}/admin/member/user/query">权限用户管理</a> &raquo; 创建用户</td></tr>
	    </thead>
	    </table>
            <div align="center">
