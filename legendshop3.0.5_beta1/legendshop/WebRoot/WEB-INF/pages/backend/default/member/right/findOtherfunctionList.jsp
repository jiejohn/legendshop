...
<%
    ...
    <thead>
    	<tr><td><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 用户管理  &raquo; <a href="${pageContext.request.contextPath}/admin/member/user/query">角色管理</a>&raquo;增加角色[${bean.name }]权限</td></tr>
    </thead>
    </table>
