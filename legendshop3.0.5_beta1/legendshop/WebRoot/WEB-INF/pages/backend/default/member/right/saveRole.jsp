...
<body>
      <form  action="${pageContext.request.contextPath}/admin/member/role/save" id="form1" method="post">      
        <table class="${tableclass}" style="width: 100%">
	    <thead>
	    	<tr><td><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 用户管理  &raquo; <a href="${pageContext.request.contextPath}/admin/member/role/query">角色管理</a> &raquo; 
	    			<c:choose>
