...
<form action="${pageContext.request.contextPath}/admin/indexjpg/save"  method="post" id="indexJpgForm" enctype="multipart/form-data" >
  ...
  <table class="${tableclass}" style="width: 100%">
    <thead>
    	<tr><td><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/indexjpg/query">首页广告图片管理</a> &raquo; 创建首页图片</td></tr>
    </thead>
    </table>
