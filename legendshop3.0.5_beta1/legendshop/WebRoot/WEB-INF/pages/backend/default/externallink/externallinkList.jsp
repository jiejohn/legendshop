...
<body>
    ...
    <thead>
    	<tr><td><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/externallink/query">链接管理</a></td></tr>
    </thead>
     <tbody><tr><td>
