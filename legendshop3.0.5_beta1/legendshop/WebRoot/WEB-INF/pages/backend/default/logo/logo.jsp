...
<html>
	...
	<body>
	    ...
	    <thead>
	    	<tr><td><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/logo/query">Logo管理</a> &raquo; 创建 Logo</td></tr>
	    </thead>
	    </table>
