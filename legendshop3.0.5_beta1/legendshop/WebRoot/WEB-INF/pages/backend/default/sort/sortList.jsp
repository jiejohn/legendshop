...
<%
  ...
  <div align="center">
    ...
    <display:table name="list" requestURI="/admin/sort/query" id="item"
     ...
     <a href="${pageContext.request.contextPath}/admin/sort/update/${item.sortId}" title="修改"><img alt="修改" src="<ls:templateResource item='/common/default/images/grid_edit.png'/> "></a>
