...
<form method="post" action="${pageContext.request.contextPath}/admin/news/save" id="form1">
    ...
    <thead>
    	<tr><td><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/news/query">新闻管理</a> &raquo; 创建新闻</td></tr>
    </thead>
        ...
        <input type="button" value="返回" onclick="window.location='${pageContext.request.contextPath}/admin/news/query'" />
        </auth:auth>
      </form>
      </center>
</body>
