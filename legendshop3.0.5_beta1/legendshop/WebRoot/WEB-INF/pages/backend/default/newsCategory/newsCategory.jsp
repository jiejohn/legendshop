...
<html>
    ...
    <body>
        <form action="${pageContext.request.contextPath}/admin/newsCategory/save" method="post" id="form1">
		    ...
		    <thead>
		    	<tr><td><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/newsCategory/query">栏目管理</a> &raquo; 创建栏目</td></tr>
		    </thead>
		    </table>
