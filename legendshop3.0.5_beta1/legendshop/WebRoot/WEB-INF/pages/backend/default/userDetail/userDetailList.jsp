...
<div align="center">
    ...
    <display:table name="list" requestURI="/system/userDetail/query" id="item"
	      ...
	      <c:choose>
	      	...
	      	<c:otherwise>
	      		<c:if test="${supportOpenShop == 'true' && 'C2C' == applicationScope.BUSINESS_MODE}">
	      			<a href='${pageContext.request.contextPath}/admin/shopDetail/load/0?userName=${item.userName}'><img alt="为用户${item.userName}增加商城" src="${pageContext.request.contextPath}/common/default/images/grid_add.png"></a>
	      		</c:if>
	      	</c:otherwise>
	      </c:choose>
	      </c:if>
 ...
 function deleteAction()
{
    ...
    window.location = '${pageContext.request.contextPath}/system/userDetail/query';
	return true;
}
  ...
  function deleteUserDetail(userId,userName) {
    ...
    function pager(curPageNO){
        ...
        function initStatus(enabledValue,haveShopValue){
			dwr.util.setValues({enabled:enabledValue});
			dwr.util.setValues({haveShop:haveShopValue});
		}	
