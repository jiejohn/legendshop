...
<form action="${pageContext.request.contextPath}/system/systemParameter/query" id="form1" method="post">
    ...
    <display:table name="list" requestURI="/system/systemParameter/query" id="item"
      ...
      <a href= "${pageContext.request.contextPath}/system/systemParameter/load/${item.name}" title="修改"><img alt="修改" src="<ls:templateResource item='/common/default/images/grid_edit.png'/> "></a>
      </display:column>
    </display:table>
...
<!--
  ...
  function deleteById(id) {
      if(confirm("  确定删除 ?")){
            window.location = "${pageContext.request.contextPath}/system/systemParameter/delete/"+id;
        }
    }
