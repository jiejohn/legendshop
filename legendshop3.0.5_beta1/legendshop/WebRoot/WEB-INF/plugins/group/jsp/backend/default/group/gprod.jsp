            ...
            <auth:auth ifAnyGranted="F_VIEW_ALL_DATA">
                <c:if test="${prod.userName != null}">
                  <option:optionGroup type="select" required="false" cache="fasle"
                    ...
                    hql="select t.sortId, t.sortName from Sort t where t.sortType = 'G' and t.userName = ?" param="${prod.userName}" />
                </c:if>
                <c:if test="${prod.userName == null}">
...
<%-- 		<select id="nsortId" name="product.nsortId" onChange="changeSubNsort(this.value)">
        ...
        <select id="brandId" name="product.brandId">
        	   <option:optionGroup type="select" required="false" cache="fasle"
                    ...
                    param="${sessionScope.SPRING_SECURITY_LAST_USERNAME}"  selectedValue="${prod.brandId}"/>
        </select>
    ...
    <tr>
     ...
     <tr>
      ...
      <td>
			最低数量&nbsp;<input type="text" name="salesMin" id="salesMin" size="10" value="${prod.groupProduct.salesMin}" maxlength="15" />&nbsp;
            最高数量&nbsp;<input type="text" name="salesMax" id="salesMax" size="10" value="${prod.groupProduct.salesMax}" maxlength="15"/>&nbsp;
            每人限购&nbsp;<input type="text" name="maxBuys" id="maxBuys" size="10" value="${prod.groupProduct.maxBuys}" maxlength="15"/>
		</td>
    </tr> 
    <tr>
      <td width="120px"><div align="center">价格</div></td>
      <td>
			原价&nbsp;<input type="text" name="product.price" id="price" size="10" value="${prod.groupProduct.product.price}" maxlength="15" />&nbsp;
            现价&nbsp;<input type="text" name="product.cash" id="cash" size="10" value="${prod.groupProduct.product.cash}" maxlength="15"/>&nbsp;
           虚拟购买&nbsp;<input type="text" name="visualBuys" id="visualBuys" size="10" value="${prod.groupProduct.visualBuys}" maxlength="15"/>
		</td>
    </tr>   
   <tr>
      <td width="120px"><div align="center">库存量</div></td>
      <td>
			<input type="text" name="product.stocks" id="stocks" size="15" value="${prod.stocks}" maxlength="15"/>      </td>
    </tr>
    <tr>
