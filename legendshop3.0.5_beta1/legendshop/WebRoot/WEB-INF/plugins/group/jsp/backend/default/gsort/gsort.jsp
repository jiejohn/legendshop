...
<form action="${pageContext.request.contextPath}/admin/gsort/save" id="sortForm" method="post" enctype="multipart/form-data">
    ...
    <thead>
    	<tr><td><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 团购管理  &raquo; <a href="${pageContext.request.contextPath}/admin/gsort/query">类型管理</a> &raquo; 创建商品类型</td></tr>
    </thead>
    </table>
