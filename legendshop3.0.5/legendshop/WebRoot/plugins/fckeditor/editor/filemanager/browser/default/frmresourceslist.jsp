...
oListManager.GetFileRowHtml = function( fileName, fileUrl, fileSize )
{
    ...
    return '<tr>' +
            ...
            '<\/td><td>&nbsp;' +
                sLink +
                 '<img  src="' + ProtectPath( fileUrl ) + '"\/><\/a>&nbsp;&nbsp;&nbsp;&nbsp;' + '&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="deleteFile(\'' + ProtectPath( fileUrl ) + '\');" > 删除 <\/a>' +
    ...
    function rndnum(){
     ...
     function deleteFile(file){
            deleteFileByDWR(escape(file));
          }
    

	function deleteFileByDWR(file) {
        CommonService.deleteFile(file,function(result){
	      if(result == 0){
              alert("文件删除成功!");
              Refresh();
           }else if(result == 1){
