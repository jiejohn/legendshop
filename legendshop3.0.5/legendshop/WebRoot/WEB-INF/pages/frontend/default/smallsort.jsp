...
<link rel="stylesheet" type="text/css" media='screen' href="${pageContext.request.contextPath}/common/default/css/overlay.css" />
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
                    <tr> 
                      <td>
						<a target="_blank" href="${pageContext.request.contextPath}/sort/${sort.sortId}${applicationScope.WEB_SUFFIX}">
          ...
          <td style="border-bottom:#cccccc 1px solid" bgcolor="#f7f7f7"> 
            <table width="100%" cellspacing="0" cellpadding="0">
              <tr> 
               ...
               <a href="${pageContext.request.contextPath}/sort/${sort.sortId}${applicationScope.WEB_SUFFIX}">${sort.sortName}</a>
                / <a href="${pageContext.request.contextPath}/nsort${applicationScope.WEB_SUFFIX}?sortId=${sort.sortId}&nsortId=${nsort.nsortId}">${nsort.nsortName}</a>
                <c:if test="${subNsort.nsortName!=null}">
                /
                 <a href="${pageContext.request.contextPath}/nsort${applicationScope.WEB_SUFFIX}?sortId=${sort.sortId}&nsortId=${nsort.nsortId}&subNsortId=${subNsort.nsortId}">${subNsort.nsortName}</a>
                </c:if>
                &nbsp;</td>
                <td  align="right"> 
