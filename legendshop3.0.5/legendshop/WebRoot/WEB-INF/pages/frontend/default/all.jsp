...
<script>
	function submitSearchAllform(entityType,keyword){
        ...
        document.getElementById("searchAllform").action = "${pageContext.request.contextPath}/searchall${applicationScope.WEB_SUFFIX}?entityType=" + entityType +"&keyword="+keyword;
...
<table width="100%">
    ...
    <table width="100%">
    	<tr>
    		<td align="left">
    		    <a href="${pageContext.request.contextPath}/index${applicationScope.WEB_SUFFIX}"><fmt:message key="shop.index"/></a>
				&nbsp;
	    		 <c:choose>
	    		...
	    		<c:if test="${'C2C' == applicationScope.BUSINESS_MODE}">
	    			<a href="${pageContext.request.contextPath}/reg${applicationScope.WEB_SUFFIX}?openshop=1"><fmt:message key="register.shop"/></a>
	    		</c:if>
    		</td>
    		<td align="right">
	...
	<tr><td align="center">
	<form action="${pageContext.request.contextPath}/searchall${applicationScope.WEB_SUFFIX}" method="post" id="searchAllform" name="searchAllform">
	<table>
	<tr><td align="left">
		<input type="text" value="${keyword}" id="keyword" name="keyword" maxlength="100" size="50" class="kw"></input>
		<input type="button" value='<fmt:message key="search.product"/>' class="btn" onmousedown="this.className='btn btn_h'" onmouseout="this.className='btn'" onclick='javascrpit:submitSearchAllform(0,document.getElementById("keyword").value)'></input>
		<c:if test="${'C2C' == applicationScope.BUSINESS_MODE}">
			<input type="button" value='<fmt:message key="search.mall"/>' class="btn" onmousedown="this.className='btn btn_h'" onmouseout="this.className='btn'" onclick='javascrpit:submitSearchAllform(1,document.getElementById("keyword").value)'></input>
		</c:if>
	</td></tr>
	</table>
	</form>
...
<table width="550px" style="margin: 10px">
	...
	<td align="left">
		<a href="${pageContext.request.contextPath}/searchall${applicationScope.WEB_SUFFIX}?entityType=1&keyword=LegendShop">LegendShop软件商城</a>
		<a href="${pageContext.request.contextPath}/searchall${applicationScope.WEB_SUFFIX}?entityType=1&keyword=360buy">360buy天天购物网</a>
    </td></tr>
	<tr><td align="right">热门商品:</td>
	<td align="left">
	<a href="${pageContext.request.contextPath}/searchall${applicationScope.WEB_SUFFIX}?entityType=0&keyword=戴尔">戴尔</a>
	<a href="${pageContext.request.contextPath}/searchall${applicationScope.WEB_SUFFIX}?entityType=0&keyword=CPU">CPU</a>
	<a href="${pageContext.request.contextPath}/searchall${applicationScope.WEB_SUFFIX}?entityType=0&keyword=索尼 SONY">SONY</a>
	<a href="${pageContext.request.contextPath}/searchall${applicationScope.WEB_SUFFIX}?entityType=0&keyword=创维">创维</a>
	<a href="${pageContext.request.contextPath}/searchall${applicationScope.WEB_SUFFIX}?entityType=0&keyword=三星 SAMSUNG">三星SAMSUNG</a>
	</td>
	</tr>
</table>
</c:if>
