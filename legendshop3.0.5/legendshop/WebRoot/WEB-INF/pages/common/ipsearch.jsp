...
<body>
<center>
<form action="${pageContext.request.contextPath}/ipsearch${applicationScope.WEB_SUFFIX}" method="post" onsubmit="return isIP();">
<table width="954px" style="border-bottom-width: 1px;border-bottom-color: red;border: 1px">
    ...
    <a href="${pageContext.request.contextPath}/index${applicationScope.WEB_SUFFIX}"><img src="${pageContext.request.contextPath}/common/images/legendshop.gif" width="160px" title="LegendShop"/></a>
     ...
     <td>
	     ...
	     <tr>
		     ...
		     <a href="${pageContext.request.contextPath}/index${applicationScope.WEB_SUFFIX}">高级搜索</a></td>
		     <td align="right">
		     	   <c:choose>
	    		...
	    		<a href="${pageContext.request.contextPath}/reg${applicationScope.WEB_SUFFIX}">用户注册</a> 
	    		<a href="${pageContext.request.contextPath}/reg${applicationScope.WEB_SUFFIX}">我要加盟</a>
				<a href="../club">论坛</a>  
             </td>
	     </tr>
	     </table>
  ...
  <OL>
    ...
    <UL type=square> 
      ...
      <LI><A href="${pageContext.request.contextPath}/p/login${applicationScope.WEB_SUFFIX}">登录</A> - 登录系统</LI>
