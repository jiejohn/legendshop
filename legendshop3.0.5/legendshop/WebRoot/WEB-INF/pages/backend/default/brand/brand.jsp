...
<html>
    ...
    <body>
	    ...
	    <thead>
	    	<tr><td><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 商品管理  &raquo; <a href="${pageContext.request.contextPath}/admin/brand/query${applicationScope.WEB_SUFFIX}">商品品牌管理</a> &raquo; 创建商品品牌</td></tr>
	    </thead>
	    </table>
                    ...
                    <td colspan="2">
                        <div align="center">
                            ...
                            <input type="button" value="返回"
                                onclick="window.location='${pageContext.request.contextPath}/admin/brand/query${applicationScope.WEB_SUFFIX}'" />
                        </div>
                    </td>
                </tr>
            </table>
