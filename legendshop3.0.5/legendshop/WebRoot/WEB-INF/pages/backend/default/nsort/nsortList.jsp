    ...
    <display:table name="list" requestURI="/admin/nsort/query${applicationScope.WEB_SUFFIX}" id="parent"
      ...
      <c:if test="${fn:length(subSortList) > 0}">
	    <display:table name="subSortList"  id="child" cellpadding="0" cellspacing="0">
	      ...
	      <a href= "${pageContext.request.contextPath}/admin/nsort/update/${child.nsortId}${applicationScope.WEB_SUFFIX}"><img alt="修改三级商品类型" src="<ls:templateResource item='/common/default/images/grid_edit.png'/> " title="修改三级商品类型"></a>
      ...
      <auth:auth ifAnyGranted="F_OPERATOR">
      <a href= "${pageContext.request.contextPath}/admin/nsort/load${applicationScope.WEB_SUFFIX}?sortId=${bean.sortId}&parentNsortId=${parent.nsortId}"><img alt="创建三级商品类型" src="${pageContext.request.contextPath}/common/default/images/grid_add.png" title="创建三级商品类型"></a>
      <a href= "${pageContext.request.contextPath}/admin/nsort/update/${parent.nsortId}${applicationScope.WEB_SUFFIX}"><img alt="修改二级商品类型" src="<ls:templateResource item='/common/default/images/grid_edit.png'/> " title="修改二级商品类型"></a>
