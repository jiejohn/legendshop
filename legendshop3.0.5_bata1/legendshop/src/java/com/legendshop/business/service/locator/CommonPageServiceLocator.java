...
public class CommonPageServiceLocator {
	 ...
	 */
	public CommonPageService getCommonPageService(HttpServletRequest request, HttpServletResponse response,String shopName,PageDefinition page){
		String template = ThreadLocalContext.getFrontType(request,response,page.getTemplates());
