...
<body class="bodymargin">
    ...
    %>
    <form action="${pageContext.request.contextPath}/admin/news/query" id="form1" method="post">
    ...
    <display:table name="list" requestURI="/admin/news/query" id="item"
      ...
      <a href= "${pageContext.request.contextPath}/admin/news/load/${item.newsId}" title="修改"><img alt="修改" src="<ls:templateResource item='/common/default/images/grid_edit.png'/> "></a>
