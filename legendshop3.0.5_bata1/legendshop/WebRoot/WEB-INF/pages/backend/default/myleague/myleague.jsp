...
<html>
    ...
    <body class="bodymargin">
	    ...
	    <thead>
	    	<tr><td><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/myleague/query">加盟商城管理</a> &raquo;  加盟商城</td></tr>
	    </thead>
	    </table>
