...
<html>
    ...
    <body class="bodymargin"> 
        <form action="${pageContext.request.contextPath}/admin/pub/save" method="post" id="form1">
		    ...
		    <thead>
		    	<tr><td><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/pub/query">公告管理</a> &raquo; 创建公告</td></tr>
		    </thead>
		    </table>
