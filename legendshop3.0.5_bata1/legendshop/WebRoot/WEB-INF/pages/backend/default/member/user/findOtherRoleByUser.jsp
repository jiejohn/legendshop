...
<%int offset=((Integer)request.getAttribute("offset")).intValue();%>
    ...
    <thead>
    	<tr><td><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 用户管理  &raquo; <a href="${pageContext.request.contextPath}/admin/member/user/query">权限用户管理</a>&raquo;增加用户[${bean.name }]角色</td></tr>
    </thead>
    </table>
