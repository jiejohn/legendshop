   ...
   <table width="100%" cellspacing="0" cellpadding="0" class="tables">
			...
			function showyear(){
				if(userBirthYearValue!=""){
					dwr.util.setValues({userBirthYear:userBirthYearValue});
				}
			}
			...
			elMonth.options.add(new Option("12", "12"));
				if(userBirthMonthValue!=""){
					dwr.util.setValues({userBirthMonth:userBirthMonthValue});
				}
			}
		...
		function showday(){
			...
			if(elMonth.value!="" && elYear.value!=""){
				...
				if(userBirthDayValue!=""){
					dwr.util.setValues({userBirthDay:userBirthDayValue});
				}
		}
