 ...
 * <li>the user-defined properties (<code>fckeditor.properties</code>)
 * if present.
 * </ol>
 * This means that user-defined properties <em>override</em> default
 * ones. In the backend it utilizes the regular {@link Properties}
 * class.
 * </p>
 * <p>
 * Moreover, you can set properties programmatically too but make sure
 * to override them <em>before</em> the first call of that specific
 * property.
 * 
...
public class PropertiesLoader {
	...
	static {
		...
		InputStream in2 = PropertiesLoader.class.getResourceAsStream(LOCAL_PROPERTIES);
	...
	/**
	 * Returns
	 * <code>connector.resourceType.file.extensions.allowed</code>
	 * property
	 */
	...
	/**
	 * Returns
	 * <code>connector.resourceType.file.extensions.denied</code>
	 * property
	 */
	...
	/**
	 * Returns
	 * <code>connector.resourceType.flash.extensions.allowed</code>
	 * property
	 */
	...
	/**
	 * Returns
	 * <code>connector.resourceType.flash.extensions.denied</code>
	 * property
	 */
	...
	/**
	 * Returns
	 * <code>connector.resourceType.image.extensions.allowed</code>
	 * property
	 */
	...
	/**
	 * Returns
	 * <code>connector.resourceType.image.extensions.denied</code>
	 * property
	 */
	...
	/**
	 * Returns
	 * <code>connector.resourceType.media.extensions.allowed</code>
	 * property
	 */
	...
	/**
	 * Returns
	 * <code>connector.resourceType.media.extensions.denied</code>
	 * property
	 */
