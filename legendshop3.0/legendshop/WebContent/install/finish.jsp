      ...
      <tr>
        <c:choose>
          ...
          * <span class="STYLE4">为了确保您网站安全，安装成功后，请把install目录删除</span><br>
          ...
          <a href='../shop/360buy'>天天购物网 360buy</a>, 密码 360buy<br>
          <br>
          	超级管理员帐号：root,密码：root <br><a href='../shop/common'>公共配置帐号common</a>,密码：common
          <br>
        ...
        <td valign="top" style="line-height:20px;"><p><br>
          * <span class="STYLE4">为了确保您网站安全，安装成功后，请把install目录删除</span><br>
          <br>
          <a href='../shop/legenddesign'>前台</a>, 密码 legenddesign<br>
