...
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8 COMMENT='购物车';
...
CREATE TABLE ls_favorite (
  ...
  prod_id varchar(32) DEFAULT NULL COMMENT '商品ID',
...
CREATE TABLE ls_login_hist (
  ...
  PRIMARY KEY (ID),
  KEY ID (ID)
) ENGINE=InnoDB AUTO_INCREMENT=199 DEFAULT CHARSET=utf8 COMMENT='登录历史表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='主广告位表';
...
CREATE TABLE ls_prod (
  prod_id int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '产品ID',
  ...
  prod_type char(1) NOT NULL DEFAULT '1' COMMENT '商品类型，1.普通商品，2团购商品，3打折商品，4二手商品',
...
CREATE TABLE ls_prod_comm (
  ID int(10) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  prod_id int(10) DEFAULT NULL COMMENT '商品ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='商品点评';
CREATE TABLE ls_prod_rel (
  rel_id int(10) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  prod_id int(10) DEFAULT NULL COMMENT '商品ID',
  rel_prod_id int(11) DEFAULT NULL COMMENT '相关产品ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='订购表';
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='我的留言';
...
) ENGINE=InnoDB AUTO_INCREMENT=96 DEFAULT CHARSET=utf8 COMMENT='客户浏览历史';
