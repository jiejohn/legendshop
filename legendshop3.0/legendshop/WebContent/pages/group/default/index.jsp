...
<!----右边end---->
    ...
    <div class="t_left">
      ...
      <div class="along">
         <div class="aligna"><span class="fl">排序方式：</span> <a href="#" class="aligna_aon">推荐</a><a href="#">人气</a><a href="#">价格</a><a href="#">即将过期</a></div>
       ...
       <!--------line1--------->
       <div class="list_item">
          <h1><a href="${pageContext.request.contextPath}/group/view/1${applicationScope.WEB_SUFFIX}" >【天河区】仅89元！价值148元广州嘉鸿华美达广场酒店单人晚餐自助餐</a></h1>
          <div class="cover"><a href="#"><img src="${pageContext.request.contextPath}/img/group/proimg.jpg" width="372" height="195" /></a></div>
          
          <div class="detail">             
            <ul class="info">               
                <li>原价<br /><label>¥299</label></li>
                <li>折扣<br /><label>2.3折</label></li>
                <li>节省<br /><label>¥229</label></li>
            </ul>
            <ul class="status">
                <li class="volume"><strong>1543</strong>人已购买</li>
                <li class="timeout">
                    <div><span>剩余</span><strong>4</strong>天<strong>0</strong>小时<strong>45</strong>分钟</div></li>
            </ul>
          </div>
          <div class="action" >
              <label><span>¥</span>89</label>
