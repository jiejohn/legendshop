...
<body class="bodymargin">
    ...
    <form action="${pageContext.request.contextPath}/admin/brand/query${applicationScope.WEB_SUFFIX}" id="form1" method="post">
	    ...
	    <thead>
	    	<tr><td><a href="${pageContext.request.contextPath}/admin/index${applicationScope.WEB_SUFFIX}" target="_parent">首页</a> &raquo; 商品管理  &raquo; <a href="${pageContext.request.contextPath}/admin/brand/query${applicationScope.WEB_SUFFIX}">品牌管理</a></td></tr>
	    </thead>
	    </table>
    ...
    <display:table name="list" requestURI="/admin/brand/query${applicationScope.WEB_SUFFIX}" id="item"
      ...
      <a href= "${pageContext.request.contextPath}/admin/brand/update/${item.brandId}${applicationScope.WEB_SUFFIX}" title="修改"><img alt="修改" src="${pageContext.request.contextPath}/img/grid_edit.png"></a>
      <auth:auth ifAnyGranted="F_OPERATOR">
      	<a href='javascript:deleteById("${item.brandId}")' title="删除"><img alt="删除" src="${pageContext.request.contextPath}/img/grid_delete.png"></a>
      </auth:auth>
      </display:column>
    </display:table>
   ...
   3. <img alt="修改" src="${pageContext.request.contextPath}/img/grid_edit.png"> 修改按钮<br>
   4. <img alt="删除" src="${pageContext.request.contextPath}/img/grid_delete.png"> 删除按钮，删除品牌，如果删除品牌则不影响其下的商品<br>
   </td><tr></table> 
