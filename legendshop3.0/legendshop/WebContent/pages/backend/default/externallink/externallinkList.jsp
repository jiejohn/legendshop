...
<body class="bodymargin">
    ...
    <display:table name="list" requestURI="/admin/externallink/query${applicationScope.WEB_SUFFIX}" id="item" 
      ...
      <a href= "${pageContext.request.contextPath}/admin/externallink/load/${item.id}${applicationScope.WEB_SUFFIX}" title="修改"><img alt="修改" src="<ls:templateResource item='/img/grid_edit.png'/> "></a>
