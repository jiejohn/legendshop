      ...
      <auth:auth ifAnyGranted="F_OPERATOR">
	      <display:column title="操作" media="html" style="width: 80px;">
		  	<c:choose>
		  	 ...
		  	 <a href= "${pageContext.request.contextPath}/admin/product/update/${item.prodId}${applicationScope.WEB_SUFFIX}" title="修改"><img alt="修改" src="<ls:templateResource item='/common/images/default/grid_edit.png'/> "></a>
