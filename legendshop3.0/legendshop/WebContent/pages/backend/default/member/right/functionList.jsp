...
<body>
    ...
    <display:table name="list" requestURI="/member/right/query${applicationScope.WEB_SUFFIX}" id="item" export="true" class="${tableclass}" style="width:100%">
      ...
      <display:column title="操作" media="html" style="width:75px">
      	<a href="${pageContext.request.contextPath}/member/right/update/${item.id}${applicationScope.WEB_SUFFIX}" ><img alt="修改" src="<ls:templateResource item='/img/grid_edit.png'/> "></a>
      	<a href="${pageContext.request.contextPath}/member/right/delete/${item.id}${applicationScope.WEB_SUFFIX}" title="删除"><img alt="删除" src="<ls:templateResource item='/img/grid_delete.png'/> "></a>
      </display:column>
    </display:table>
