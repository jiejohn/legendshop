...
<html>
    ...
    <body>
        <form action="${pageContext.request.contextPath}/admin/imgFile/save${applicationScope.WEB_SUFFIX}" method="post" id="form1">
                    ...
                    <td colspan="2">
                        <div align="center">
                            ...
                            <input type="button" value="返回"
                                onclick="window.location='${pageContext.request.contextPath}/admin/imgFile/query${applicationScope.WEB_SUFFIX}'" />
                        </div>
                    </td>
                </tr>
            </table>
