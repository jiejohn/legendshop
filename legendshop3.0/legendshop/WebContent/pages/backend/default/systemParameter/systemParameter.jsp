...
<html>
    ...
    <body>
        <form action="${pageContext.request.contextPath}/system/systemParameter/save${applicationScope.WEB_SUFFIX}" method="post" id="form1">
                    ...
                    <td colspan="2">
                        <div align="center">
                            ...
                            <input type="button" value="返回"
                                onclick="window.location='${pageContext.request.contextPath}/system/systemParameter/query${applicationScope.WEB_SUFFIX}'" />
                        </div>
                    </td>
                </tr>
            </table>
