...
<html>
    ...
    <body>
        <form action="${pageContext.request.contextPath}/admin/paytype/save${applicationScope.WEB_SUFFIX}" method="post" id="form1">
            <input id="payId" name="payId" value="${bean.payId}" type="hidden">
            <div align="center">
          <table class="${tableclass}" style="width: 100%">
		    <thead>
		    	<tr><td><a href="<ls:url address='/admin/index'/>" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/paytype/query${applicationScope.WEB_SUFFIX}">支付管理</a> &raquo; 创建支付方式</td></tr>
		    </thead>
		    </table>
        ...
        <td>
                 <select id="payTypeId" name="payTypeId">
				  <option:optionGroup type="select" required="true" cache="true"
	                beanName="PAY_TYPE" selectedValue="${bean.payTypeId}"/>
	            </select>
        </td>
      </tr>
     <tr>
                    ...
                    <td colspan="2">
                        <div align="center">
                            ...
                            <input type="button" value="返回"
                                onclick="window.location='${pageContext.request.contextPath}/admin/paytype/query${applicationScope.WEB_SUFFIX}'" />
                        </div>
                    </td>
                </tr>
            </table>
