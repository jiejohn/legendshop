...
<body class="bodymargin">
	...
	<form action="${pageContext.request.contextPath}/admin/logo/query${applicationScope.WEB_SUFFIX}" id="form1" method="post">
	    ...
	    <thead>
	    	<tr><td><a href="${pageContext.request.contextPath}/admin/index${applicationScope.WEB_SUFFIX}" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/logo/query${applicationScope.WEB_SUFFIX}">Logo管理</a></td></tr>
	    </thead>
	    </table>
	...
	<div align="center">
        ...
        <display:table name="list" requestURI="/admin/logo/query${applicationScope.WEB_SUFFIX}" id="item"
            ...
            <display:column title="操作" media="html" class="actionwidth">
                 <a href= "${pageContext.request.contextPath}/admin/logo/load/${item.id}${applicationScope.WEB_SUFFIX}" title="修改"><img alt="修改" src="${pageContext.request.contextPath}/img/grid_edit.png"></a> 
