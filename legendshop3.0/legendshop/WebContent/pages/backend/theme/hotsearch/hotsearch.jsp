...
<html>
    ...
    <body class="bodymargin">
       ...
       <table class="${tableclass}" style="width: 100%">
	    <thead>
	    	<tr><td><a href="/member/" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/hotsearch/query${applicationScope.WEB_SUFFIX}">热门商品管理</a> &raquo; 创建热门商品</td></tr>
	    </thead>
	    </table>
