...
<body class="bodymargin">
    ...
    <thead>
    	<tr><td><a href="/member/" target="_parent">首页</a> &raquo; 商品管理  &raquo; <a href="${pageContext.request.contextPath}/admin/hotsearch/query${applicationScope.WEB_SUFFIX}">热门商品管理</a></td></tr>
    </thead>
    </table>
