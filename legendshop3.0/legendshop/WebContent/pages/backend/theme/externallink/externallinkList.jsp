...
<body class="bodymargin">
    ...
    <thead>
    	<tr><td><a href="/member/" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/externallink/query${applicationScope.WEB_SUFFIX}">链接管理</a></td></tr>
    </thead>
    </table>
