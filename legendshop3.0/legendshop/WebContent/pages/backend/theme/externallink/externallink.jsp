...
<html>
  ...
  <body class="bodymargin">
   <table class="${tableclass}" style="width: 100%">
    <thead>
    	<tr><td><a href="/member/" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/externallink/query${applicationScope.WEB_SUFFIX}">连接管理</a> &raquo; 创建友情连接</td></tr>
    </thead>
    </table>
