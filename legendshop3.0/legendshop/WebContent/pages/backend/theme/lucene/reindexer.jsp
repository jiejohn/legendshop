...
function writeTimeGroup(fieldNamePrefix)
{
	...
	<body class="bodymargin">
		<form action="${pageContext.request.contextPath}/system/lucene/reindex${applicationScope.WEB_SUFFIX}" method="post" id="form1"
			 onSubmit="return validateReindexForm(this);">
			<input id="id" name="id" value="${bean.id}" type="hidden">
			<div align="center">
		 <table class="${tableclass}" style="width: 100%">
	    <thead>
	    	<tr><td><a href="/member/" target="_parent">首页</a> &raquo; 系统管理  &raquo; <a href="${pageContext.request.contextPath}/system/lucene/query${applicationScope.WEB_SUFFIX}">重建索引</a></td></tr>
	    </thead>
	    </table>
