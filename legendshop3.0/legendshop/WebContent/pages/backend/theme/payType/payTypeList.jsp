...
<body>
    ...
    <thead>
    	<tr><td><a href="/member/" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/paytype/query${applicationScope.WEB_SUFFIX}">支付管理</a></td></tr>
    </thead>
    </table>
