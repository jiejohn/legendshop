...
<body>
    ...
    <thead>
    	<tr><td><a href="/member/" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/visitLog/query${applicationScope.WEB_SUFFIX}">浏览历史</a></td></tr>
    </thead>
    </table>
