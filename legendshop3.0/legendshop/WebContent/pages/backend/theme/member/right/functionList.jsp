...
<table width="100%"  align="center" class="tableBorder" style="margin-top: 5px">
  <tr>
    <th height="32" colspan="9" scope="col">权限列表</th>
  </tr>
  ...
  <tr>
    ...
    <td align="center" class="forumRow">
        <html:link href="findFunctionById${applicationScope.WEB_SUFFIX}" paramId="id" paramName="function" paramProperty="id">修改</html:link>
     </td>
    <td align="center" class="forumRow">
        <html:link page="/member/right/deleteFunctionById${applicationScope.WEB_SUFFIX}" paramId="id" paramName="function" paramProperty="id" onclick="return confirmDelete();">删除</html:link>
     </td>
  </tr>
  </logic:present>
  </logic:iterate>
	...
	<logic:present name="toolBar">
		...
		<div align="center">
		<P> 点击此处
		  <html:link page="/member/right/saveFunction.jsp">创建权限</html:link>
		</div>
</body>
</html:html>
