...
<% Integer offset = (Integer)request.getAttribute("offset");%>
    ...
    <thead>
    	<tr><td><a href="/member/" target="_parent">首页</a> &raquo; 商品管理  &raquo; <a href="${pageContext.request.contextPath}/admin/indexjpg/query${applicationScope.WEB_SUFFIX}">首页Flash图片管理</a></td></tr>
    </thead>
    </table>
    ...
    <display:table name="list" requestURI="/admin/indexjpg/query${applicationScope.WEB_SUFFIX}" id="item"
      ...
      <display:column title="图片"><a href="${pageContext.request.contextPath}/photoserver/photo/${item.img}" target="_blank"><img src="${pageContext.request.contextPath}/img/filter_search.png"></a></display:column>
      <display:column title="链接">
      	    	<a href="${item.link}" target="_blank"><img src="${pageContext.request.contextPath}/img/grid_refresh.png" title="图片"></a>
    	        <a href="${pageContext.request.contextPath}/${item.titleLink}" target="_blank"><img src="${pageContext.request.contextPath}/img/grid_refresh.png" title="文字"></a>
      </display:column>
      <auth:auth ifAnyGranted="F_VIEW_ALL_DATA">
