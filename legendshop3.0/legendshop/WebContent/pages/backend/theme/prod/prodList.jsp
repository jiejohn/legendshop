...
<form action="${pageContext.request.contextPath}/admin/product/query${applicationScope.WEB_SUFFIX}" id="form1" method="post">
      ...
      <auth:auth ifAnyGranted="F_OPERATOR">
	      <display:column title="操作" media="html" style="width: 80px;">
		  	<c:choose>
		  	 ...
		  	 <a href= "${pageContext.request.contextPath}/admin/product/update/${item.prodId}${applicationScope.WEB_SUFFIX}" title="修改"><img alt="修改" src="${pageContext.request.contextPath}/img/grid_edit.png"></a>
		     <a href='javascript:confirmDelete("${item.prodId}","${item.name}")' title="删除"><img alt="删除" src="${pageContext.request.contextPath}/img/grid_delete.png"></a>
	      </display:column>
      </auth:auth>
    </display:table>
   ...
   6. <img alt="修改" src="${pageContext.request.contextPath}/img/grid_edit.png"> 修改按钮<br>
   7. <img alt="删除" src="${pageContext.request.contextPath}/img/grid_delete.png"> 删除按钮<br>
   </td><tr></table> 
