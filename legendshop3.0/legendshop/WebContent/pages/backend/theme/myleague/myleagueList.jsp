...
<body class="bodymargin">
    ...
    <form action="${pageContext.request.contextPath}/admin/myleague/query${applicationScope.WEB_SUFFIX}" id="form1" method="post">
	    ...
	    <thead>
	    	<tr><td><a href="${pageContext.request.contextPath}/admin/index${applicationScope.WEB_SUFFIX}" target="_parent">首页</a> &raquo; 商城管理  &raquo; <a href="${pageContext.request.contextPath}/admin/myleague/query${applicationScope.WEB_SUFFIX}">加盟商城管理</a></td></tr>
	    </thead>
	    </table>
    ...
    <display:table name="list" requestURI="/admin/myleague/query${applicationScope.WEB_SUFFIX}" id="item"
      ...
      <a href= "${pageContext.request.contextPath}/admin/myleague/load/${item.id}${applicationScope.WEB_SUFFIX}"><img alt="修改" src="${pageContext.request.contextPath}/img/grid_edit.png"></a>
      <auth:auth ifAllGranted="F_OPERATOR">
      <a href='javascript:deleteById("${item.id}")'><img alt="删除" src="${pageContext.request.contextPath}/img/grid_delete.png"></a>
      </auth:auth>
      </display:column>
    </display:table>
