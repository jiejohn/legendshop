	...
	<tr><td><center>
            ...
            <td>
            	...
            	<table cellpadding="2px" style="margin-left: 20px" align="left">
	            	<tr><td align="left"><img src="<ls:templateResource item='/img/004.gif'/>"/><fmt:message key="not.member.hint"/>,&nbsp;<a href="<ls:url address='/reg'/>"><fmt:message key="regFree"/></a></td></tr>
	            	<tr><td align="left"><img src="<ls:templateResource item='/img/004.gif'/>"/><fmt:message key="goto.home"/>&nbsp;<a href="<ls:url address='/index'/>"><fmt:message key="shop.index"/></a></td></tr>
	            	<tr><td align="left"><img src="<ls:templateResource item='/img/004.gif'/>"/><fmt:message key="forget.password.hint"/>
