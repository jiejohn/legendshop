...
<!--
		function pager(curPageNO){
			window.location.href="${pageContext.request.contextPath}/allNews${applicationScope.WEB_SUFFIX}?curPageNO="+curPageNO;
		}
          ...
          <tr> 
           ...
           <c:forEach items="${requestScope.list}" var="news" varStatus="status">
			<tr> 
                ...
                <div>
					&nbsp;${status.index+1}.
					<a href="${pageContext.request.contextPath}/news/${news.newsId}${applicationScope.WEB_SUFFIX}">
					<c:choose>
