...
<script type="text/javascript" src="${pageContext.request.contextPath}/common/js/funcs.js"></script>
<div id="bodyer">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/common/js/couplet.js"></script>
...
<!--
    ...
    if(showad){
	var ClosebuttonHtml = '<div align="right" style="position: absolute;top:0px;right:0px;margin:2px;padding:0px;z-index:2000;"><a href="javascript:void(0)" onclick="hidead()" style="color:black;text-decoration:none;font-size:12px;"><img src="${pageContext.request.contextPath}/img/close.gif"/></a></div>'
    ...
    if(dataArray!="undefined" || dataArray != null){
        ...
        if(MaxScreen == 0){
                     ...
                     var imgorder = "img1";
                     var imgs = document.getElementById(imgorder);
                     imgs.src = '${pageContext.request.contextPath}/img/common.jpg';
