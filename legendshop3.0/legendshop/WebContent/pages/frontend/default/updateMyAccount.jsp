...
<tr><td><a href="${adv.linkUrl}"><img src="${pageContext.request.contextPath}/photoserver/photo/${adv.picUrl}" title="${adv.title}"/></a></td></tr>
 </table>
</c:forEach>
   ...
   <table width="100%" cellspacing="0" cellpadding="0" class="tables">
                ...
                <tr> 
                  <td height="2"> <table width="100%" cellspacing="0" cellpadding="0" height="100%">
                      <tr>
                        <td align="left"> 
                        <form action="${pageContext.request.contextPath}/updateAccount${applicationScope.WEB_SUFFIX}" method="post" name="userUpdateForm" id="userUpdateForm">
                            ...
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" style="margin-bottom: 6">
                                 ...
                                 &nbsp; 
                                  <c:choose>
                                  	<c:when test="${requestScope.myShopDetail == null}">
                                  		<fmt:message key="shop.not.open"/><font style="font-weight: bold; color: #CCFFCC"><a href="${pageContext.request.contextPath}/openShop${applicationScope.WEB_SUFFIX}"><fmt:message key="apply.hint"/></a></font>?
                                  	</c:when>
                                  	<c:otherwise>
                              ...
                              <tr> 
								...
								<select name="userBirthYear" id="userBirthYear" size="1" onchange="showmonth();showday()">
									<script>
										var yearbegin=1980,yearend=2010;
              ...
              <script type="text/javascript">
				...
				var elYear = document.getElementById("userBirthYear");
				var elMonth = document.getElementById("userBirthMonth");


			function showyear(){
				if(userBirthYearValue!=""){
					DWRUtil.setValues({userBirthYear:userBirthYearValue});
				}
			}
			
			function showmonth(){
			elMonth.options.add(new Option("01", "01"));
			elMonth.options.add(new Option("02", "02"));
			elMonth.options.add(new Option("03", "03"));
			elMonth.options.add(new Option("04", "04"));
			elMonth.options.add(new Option("05", "05"));
			elMonth.options.add(new Option("06", "06"));
			elMonth.options.add(new Option("07", "07"));
			elMonth.options.add(new Option("08", "08"));
			elMonth.options.add(new Option("09", "09"));
			elMonth.options.add(new Option("10", "10"));
			elMonth.options.add(new Option("11", "11"));
			elMonth.options.add(new Option("12", "12"));
				if(userBirthMonthValue!=""){
					DWRUtil.setValues({userBirthMonth:userBirthMonthValue});
				}
			}

		function showday(){
			var elDay = document.getElementById("userBirthDay");
			if(elMonth.value!="" && elYear.value!=""){
				elDay.length=0;
				elDay.options.add(new Option("01", "01"));
				elDay.options.add(new Option("02", "02"));
				elDay.options.add(new Option("03", "03"));
				elDay.options.add(new Option("04", "04"));
				elDay.options.add(new Option("05", "05"));
				elDay.options.add(new Option("06", "06"));
				elDay.options.add(new Option("07", "07"));
				elDay.options.add(new Option("08", "08"));
				elDay.options.add(new Option("09", "09"));
				for(var i=10;i<28;i++){
				...
				if(userBirthDayValue!=""){
					DWRUtil.setValues({userBirthDay:userBirthDayValue});
				}
		}
