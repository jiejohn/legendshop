...
<script type="text/javascript">
   ...
   jQuery.validator.addMethod("checkEmail1", function(value, element) {
	...
	if(nameValue.length >= 4 && nameValue.isAlpha() ){
		CommonService.isUserExist(nameValue, function(retData){
		if(retData){
			result = false;
		  }
	    }) ;
	...
	if(isEmail(userMailValue)){
		CommonService.isEmailExist(userMailValue, function(retData){
		if(retData){
			result = false;
		  }
	    }) ;
   ...
   <table width="100%" cellspacing="0" cellpadding="0" class="tables"> 
                ...
                <tr> 
                  <td height="2" bgcolor="#FFFFF6"><table width="100%" cellspacing="0" cellpadding="0" height="100%">
                      <tr> 
                        <td align="left">
                        <form action="${pageContext.request.contextPath}/userReg${applicationScope.WEB_SUFFIX}" method="post" name="userRegForm" id="userRegForm" enctype="multipart/form-data">
                        ...
                        <br>
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" style="margin-bottom: 6">
                              ...
                              <tr> 
                                ...
                                <td height="29"><div align="left"> 
                                   <a href="${pageContext.request.contextPath}/regItem${applicationScope.WEB_SUFFIX}" target="_blank"><fmt:message key="UserAgreement"/></a><input type="checkbox" id="agreement" name="agreement" checked="checked"/>
