  	        ...
  	        <table cellspacing="0" cellpadding="0" width="100%"> 
                          ...
                          <c:when test="${fn:length(nsort.nsortName) > 8}">
                            <td align="left" title="${nsort.nsortName}">
                                <img src="${pageContext.request.contextPath}/img/004.gif"><a href="${pageContext.request.contextPath}/nsort/${sort.sortId}-${nsort.nsortId}${applicationScope.WEB_SUFFIX}">${fn:substring(nsort.nsortName,0,8)}..</a>
                            </td>
                          </c:when>
                          <c:otherwise>
                            <td align="left"">
                                <img src="${pageContext.request.contextPath}/img/004.gif"><a href="${pageContext.request.contextPath}/nsort/${sort.sortId}-${nsort.nsortId}${applicationScope.WEB_SUFFIX}">${nsort.nsortName}</a>
                            </td>
                          </c:otherwise>
                        </c:choose>
