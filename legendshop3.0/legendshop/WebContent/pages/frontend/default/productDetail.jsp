                            ...
                            <table width="100%">
                                ...
                                <tr> 
                                  ...
                                  <td height="25"> 
                                    ...
                                    <a href="${pageContext.request.contextPath}/sort/${prod.sortId}${applicationScope.WEB_SUFFIX}">${prod.sortName}</a>
                                     <c:if test="${not empty prod.nsortName}">
                                     / <a href="${pageContext.request.contextPath}/nsort${applicationScope.WEB_SUFFIX}?sortId=${prod.sortId}&nsortId=${prod.nsortId}">${prod.nsortName}</a>
                                     </c:if>   
                                     <c:if test="${not empty prod.subNsortName}">
                                     / <a href="${pageContext.request.contextPath}/nsort${applicationScope.WEB_SUFFIX}?sortId=${prod.sortId}&nsortId=${prod.nsortId}&subNsortId=${prod.subNsortId}">
                                     ${prod.subNsortName}</a>
                                     </c:if>    
                                    </div>
                                  </td>
                                ...
                                <tr> 
                                  <td colspan="2">
                                  <div align="left" class="prodattr">
                                    <jsp:include page="/dynamic/attribute/${prod.prodId}${applicationScope.WEB_SUFFIX}" flush="true"/>
                                    </div>
                                  </td>
                                </tr>                 
                                   </c:if>
                                  ...
                                  <td height="30" colspan="2" align="center">
                                   ...
                                   <c:choose>
                                   	<c:when test="${prod.stocks != null && prod.cash != null && prod.stocks > 0}">
                                   		...
                                   		<img  src="${pageContext.request.contextPath}/img/buynows.jpg" title='<fmt:message key="order" />' />
                                   	</c:when>
                                   	<c:otherwise><a href="${pageContext.request.contextPath}/leaveword${applicationScope.WEB_SUFFIX}"> <img  src="${pageContext.request.contextPath}/img/productless.jpg" title='<fmt:message key="notice.product.less" />' /></a></c:otherwise>
                                   </c:choose>
