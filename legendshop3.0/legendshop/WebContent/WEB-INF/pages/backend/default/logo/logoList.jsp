	...
	<div align="center">
        ...
        <display:table name="list" requestURI="/admin/logo/query${applicationScope.WEB_SUFFIX}" id="item"
            ...
            <display:column title="操作" media="html" class="actionwidth">
                 <a href= "${pageContext.request.contextPath}/admin/logo/load/${item.id}${applicationScope.WEB_SUFFIX}" title="修改"><img alt="修改" src="<ls:templateResource item='/common/default/images/grid_edit.png'/> "></a> 
