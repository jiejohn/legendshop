...
<body>
    ...
    <display:table name="list" requestURI="/admin/productcomment/query${applicationScope.WEB_SUFFIX}" id="item"
      ...
      <display:column title="操作" media="html" class="actionwidth">
      		<a href= "${pageContext.request.contextPath}/admin/productcomment/load/${item.id}${applicationScope.WEB_SUFFIX}" title="回复"><img alt="回复" src="<ls:templateResource item='/common/default/images/grid_edit.png'/> "></a>
