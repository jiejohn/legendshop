 ...
 <div class="w" style="padding-top:10px;"> 
    <!-----------leftm-------------->
     <div class="leftm">
			...
			<div  class="m10 m0">
              <div class="mt"><h2>浏览最终购买</h2></div>
              <div class="mc">
                 <ul>
                   <li>
                     <div class="m0-img">
                     <a href="#" target="_blank"><img src="../images/mosample.jpg" alt="" height="110" width="100"></a>
                     </div>
                     <div class="rate" ><a href="#"  target="_blank">周末放价，强悍小Y仅4599，抢完关仓！精工之作，唯美首选！强劲小Y，性能无可比拟！</a></div>
                     <div class="m0-price">￥899.00</div>
                   </li>
                   <li>
                     <div class="m0-img">
                     <a href="#" target="_blank"><img src="../images/mosample.jpg" alt="" height="110" width="100"></a>
                 ...
                 <div class="more"><a target="_blank" title="查看更多" href="#" >查看更多推荐</a></div>
                 </div>
             </div><!--关注手机最终购买-->
            ...
            <div  class="m10 m0">
              <div class="mt"><h2>最近浏览过得商品</h2></div>
              <div class="mc">
                 <ul>
                   <li>
                     <div class="m0-img">
