...
<form id="form1" method="post" action="buy${applicationScope.WEB_SUFFIX}">
                          ...
                          <tr> 
                            ...
                            <table width="100%" border="1" cellpadding="0" cellspacing="0" 
                               style="border-collapse: collapse;margin-top: 7px;border: 1px solid #CCCCCC;"  bgcolor="#ECECEC">
                                <tr align="center">
                                  <td height="30" colspan="2" style="margin-left: 10px"><b><a href="${pageContext.request.contextPath}/views/${prod.prodId}${applicationScope.WEB_SUFFIX}">${prod.name}</a></b></td>
                                </tr>
                                <tr bgcolor="#FFFFFF"> 
