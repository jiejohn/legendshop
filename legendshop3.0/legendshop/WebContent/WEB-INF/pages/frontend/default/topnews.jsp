...
<table width="205px" cellspacing="0" cellpadding="0" style="margin-right: 5px;margin-bottom: 4px;margin-left: 0px;margin-top: 4px" class="tables" >
	<tr>
		<td class="titlebg"><fmt:message key="newsCenter"/>
			 <a href="${pageContext.request.contextPath}/allNews${applicationScope.WEB_SUFFIX}"><img src="${pageContext.request.contextPath}/common/default/images/more.gif" width="45px" /></a>
		</td>
	</tr>
	<tr height="136px">
