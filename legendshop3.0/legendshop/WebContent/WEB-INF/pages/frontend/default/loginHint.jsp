    ...
    <td align="left">
    	<div style="margin-left: 50px;margin-bottom: 20px;margin-top: 20px">
     		<fmt:message key="nologin.hint.self">
     			<fmt:param value="${pageContext.request.contextPath}/admin/login${applicationScope.WEB_SUFFIX}?returnUrl=${returnUrl}"></fmt:param>
     			<fmt:param value="${pageContext.request.contextPath}/reg${applicationScope.WEB_SUFFIX}"></fmt:param>
     		</fmt:message>
     	</div>
    </td>
  </tr>
