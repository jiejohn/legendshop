...
public class IndexJpgAdminController extends BaseController {
	...
	public String query(HttpServletRequest request, HttpServletResponse response, String curPageNO, Indexjpg indexjpg) {
		...
		return PathResolver.getPath(request, PageLetEnum.IJPG_LIST_PAGE);
	}
	...
	public String save(HttpServletRequest request, HttpServletResponse response, Indexjpg indexjpg) {
		...
		return PathResolver.getPath(request, PageLetEnum.IJPG_LIST_QUERY);
	}
	...
	private String  checkMaxJpgNum(HttpServletRequest request, Long num) {
		...
		if ((num != null) && (num >= maxNum)) {
			...
			uem.addCallBackList("重新上传", "",  PathResolver.getPath(request, PageLetEnum.IJPG_EDIT_PAGE));
