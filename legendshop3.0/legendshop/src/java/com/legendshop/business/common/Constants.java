...
public class Constants implements AttributeKeys {
	...
	// couplet ad
	/** The Constant COUPLET. */
	public static final String COUPLET = "COUPLET";
	...
	/** The Constant HW_TEMPLATE_ATTRIBUTE. */
	public static final Short HW_TEMPLATE_ATTRIBUTE = 1;
