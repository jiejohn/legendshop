...
public class ContextPathBuilder extends ServerRootPathBuilder {
	...
	public String getUserFilesPath(HttpServletRequest request) {
		...
		return new StringBuffer().append(super.getUserFilesPath(request)).append("/").append(userName).append(
				"/fckeditor").toString();
	}
	...
	public String getUserFilesAbsolutePath(HttpServletRequest request) {
		...
		return new StringBuffer().append(PropertiesUtil.getBigFilesAbsolutePath()).append("/").append(userName).append(
				"/fckeditor").toString();
	}
